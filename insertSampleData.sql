-- =======================================================
-- 14) INSERT SAMPLE DATA (FULL - ĐÃ CẬP NHẬT 3 BẢNG MỚI)
-- =======================================================
USE shopbtl;
...
-- 17) PAYMENT METHOD (5 dòng) - Phương thức thanh toán cho các đơn hàng
...
-- 18) FINANCIAL REPORT (5 dòng)

INSERT INTO `financialReport` (`createdDate`, `endDate`, `adminID`, `commissionRate`, `totalRevenue`) 
VALUES 
('2025-07-01 00:00:00', '2025-07-31 23:59:59', 10, 0.05, 42000000), -- Tháng 7
('2025-08-01 00:00:00', '2025-08-31 23:59:59', 10, 0.05, 48000000), -- Tháng 8
('2025-09-01 00:00:00', '2025-09-30 23:59:59', 10, 0.05, 45000000), -- Tháng 9
('2025-10-01 00:00:00', '2025-10-31 23:59:59', 10, 0.05, 50000000), -- Tháng 10
('2025-11-01 00:00:00', '2025-11-30 23:59:59', 10, 0.05, 60000000); -- Tháng 11

-- 19) FINANCIAL REPORT SELLER (5 dòng)
ng 11
INSERT INTO `financialReport_seller` (`createdDate`, `sellerID`, `sellerRevenue`) 
VALUES 
('2025-11-01 00:00:00', 1, 8000000),  -- Shop 1
('2025-11-01 00:00:00', 2, 6000000),  -- Shop 2
('2025-11-01 00:00:00', 3, 7000000),  -- Shop 3
('2025-11-01 00:00:00', 4, 9000000),  -- Shop 4
('2025-11-01 00:00:00', 6, 5000000);  -- Shop 6